...
class Manuscript(object):
    ...
    def parse_manuscript_record(self):
        ...
        # return bool so that Main function can evaluate 
        # whether there are valid segments
...
if __name__ == '__main__':
    ...
    ms_movements = []
    for manuscript in set([x[0] for x in valid_data]):
        m = Manuscript([p for p in valid_data if p[0] == manuscript], manuscript)
